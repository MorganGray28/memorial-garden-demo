...
export const TableList = React.forwardRef((props, ref) => {
    ...
    const plots = props.plotData
        .map(p =>
            <StyledTableList key={p.location} onClick={handleClick.bind(p)}>
                ...
                <Box sx={{
                    ...
                    <Chip label={p.plotFilledStatus} variant="filled" color={chipColor[p.plotFilledStatus]}/>
                </Box>
