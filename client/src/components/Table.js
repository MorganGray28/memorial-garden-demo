...
export default function Table(props) {
	...
	return (
		<Box
			sx={{ maxHeight: { xs: '550px', sm: '680px', md: '750px' }, overflow: 'auto', position: 'relative' }}
		>
			<Typography pt={2} mb={1} fontWeight={500}>
				Filter List By:
			</Typography>
			<Box sx={{ display: 'flex', justifyContent: { xs: 'space-between', md: 'flex-start' } }}>
				...
				<Box
					sx={{ alignSelf: 'center', marginRight: { xs: '10px', sm: '35px' }, marginLeft: { md: '50px' } }}
				>
					<ReactToPrint
						trigger={() => (
